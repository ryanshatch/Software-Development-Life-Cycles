...
// public class TopFiveDestinationList33 { // This is the main class

// // private static final int MAX_WIDTH = 300; // Maximum width in pixels for
// the
// // text
...
// topDestinationListFrame.setTitle("Top 5 Destinations"); // This is the title
// of the frame
...
// label
// nameLabel.setForeground(Color.DARK_GRAY); // Set the foreground (text) color
// for the label
// nameLabel.setBackground(Color.CYAN); // Set the background color for the
// label
...
// "<html><center><div style='width: %dpx; word-wrap:
// break-word;'>%s</div></center></html>",
// MAX_WIDTH, text); // This is the text that will be displayed and formatted to
// fit the frame
...
// private static final Color BACKGROUND_COLOR = new Color(120, 240, 120); //
// Light green background
// private static final Color SELECTED_BACKGROUND_COLOR = new Color(0, 120, 0);
// // A dark green shade for selection
// private static final Color SELECTED_TEXT_COLOR = Color.WHITE; // White text
// for selection

// public TextAndIconListCellRenderer(int padding) {
// insideBorder = BorderFactory.createEmptyBorder(padding, padding, padding,
// padding);
// setOpaque(true); // This is the background color

// // Custom font for the list items
// setFont(new Font("Arial", Font.BOLD, 14)); // This is the font type, style,
// and size
// }

// public Component getListCellRendererComponent(JList<? extends TextAndIcon>
// list, TextAndIcon value,
...
// Border outsideBorder = cellHasFocus ?
